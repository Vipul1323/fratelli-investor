...
@section('content')
    <div class="card card-custom gutter-b">
        {!! Form::open(array('route' => ['admin.folders.edit', $folderObj->id]  , 'class' => 'form', 'id'=>'create', 'files'=>true)) !!}
            <div class="card-body">
                <input type="hidden" name="parent_id" id="parent_id" value="{{ $folderObj->parent_id }}">
                <div class="row">
                    <div class="col-lg-5">
                    ...
                    <div class="col-lg-7">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                {!! Form::text('folder_name', $folderObj->name, ['class' => 'form-control','placeholder' => 'Enter Folder Name' ]) !!}
                            </div>
                        </div>
                    </div>
                </div>
